...
def read_csv_(file_name, names, delimiter='t'):
    ...
    return pd.read_csv(file_name, sep=sep, quoting=csv.QUOTE_NONE, skip_blank_lines=False, header=None,
                       names=names)
    # return pd.read_excel(file_name, sep=sep, quoting=csv.QUOTE_NONE, skip_blank_lines=False, header=None,
    #                     names=names)

# data = read_csv_("D:\\pycharm_project\\sequence-labeling-BiLSTM-CRF-master\\data\\example_datasets3\\train.csv",names=['token','label'],delimiter='d')
